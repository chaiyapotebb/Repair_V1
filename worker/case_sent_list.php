...
?>
<h2 class="text-center">แสดงรายการบันทึกแจ้งซ่อม</h2>
<hr>
...
<thead>
    ...
    <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;">ซ่อมเสร็จแล้ว</th>
    </tr>
</thead>
<tbody>
    ...
    <tr>
        ...
        <td class="align-middle">
            <a class="btn btn-outline-danger btn-sm btn-block" href="case_success_db.php?case_id=<?php echo $row['case_id']; ?>"><i class="bi bi-check-circle-fill"></i> บันทึกแจ้งซ่อม</a>
        </td>
    </tr>
    <?php } ?>  
</tbody>
